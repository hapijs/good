...
module.exports = internals.Monitor = function (plugin, options) {
    ...
    options = options || {};
    var _subscriptions = options.subscribers;
    ...
    options.subscribers = _subscriptions || [{ broadcaster: GoodConsole }];
