...
internals.monitorOptions = Joi.object().keys({
    ...
    requestHeaders: Joi.array().items(Joi.string().valid('response', 'wreck')),
    responseHeaders: Joi.array().items(Joi.string().valid('response', 'wreck')),
    requestPayload: Joi.array().items(Joi.string().valid('response', 'wreck')),
    responsePayload: Joi.array().items(Joi.string().valid('response', 'wreck')),
