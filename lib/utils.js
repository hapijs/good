...
exports.GreatResponse = function (request, options, filterRules) {
    ...
    if ((typeof options.requestHeaders === 'boolean' && options.requestHeaders) || (Array.isArray(options.requestHeaders) && ~options.requestHeaders.indexOf('response'))) {
        this.headers = req.headers;
    }

    if ((typeof options.requestPayload === 'boolean' && options.requestPayload) || (Array.isArray(options.requestPayload) && ~options.requestPayload.indexOf('response'))) {
        this.requestPayload = request.payload;
    }

    if (((typeof options.responsePayload === 'boolean' && options.responsePayload) || (Array.isArray(options.responsePayload) && ~options.responsePayload.indexOf('response'))) && request.response) {
...
exports.GreatWreck = function (error, request, response, start, uri, options, payload) {

    if (this.constructor !== exports.GreatWreck) {
        return new exports.GreatWreck(error, request, response, start, uri, options, payload);
    }
    ...
    if ((typeof options.requestHeaders === 'boolean' && options.requestHeaders) || (Array.isArray(options.requestHeaders) && ~options.requestHeaders.indexOf('wreck'))) {
    ...
    if ((typeof options.responseHeaders === 'boolean' && options.responseHeaders) || (Array.isArray(options.responseHeaders) && ~options.responseHeaders.indexOf('wreck'))) {
