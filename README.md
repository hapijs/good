...
- `wreck` - Wreck module request/response logging information.  Note: Wreck has to be installed at the top level in order for this to work due to it being a singleton.
